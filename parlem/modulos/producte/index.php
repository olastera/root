...
$users = new cProducte;
$lista = $users->consulta_paginada($_SESSION['session']['paginacion']);

$table = $users->lista($lista);
...
<body>
        ...
        <div class="col-12 mb-3">
          <form method="get">
            <div class="input-group input-group-lg">
              <input type="text" class="form-control " placeholder="Buscar producto" autofocus="" name="text" value="<?php echo $_SESSION['session']['paginacion']['text'] ?>">
  ...
  <script>
    let btnUserComo_all = document.querySelectorAll(".btnUserComo");
    btnUserComo_all.forEach(btnUserComo => {
      btnUserComo.addEventListener('click', function(event) {
        //e.preventDefault();
        FetchGet(URL + 'modulos/login/login_como.php?datos=' + this.dataset.dato, "")
      });
    });
  </script>
</body>
